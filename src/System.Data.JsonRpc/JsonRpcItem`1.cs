...
namespace System.Data.JsonRpc
{
        ...
        where T : JsonRpcMessage
    {
        ...
        public JsonRpcException GetException()
        {
            if (IsValid)
            {
                throw new JsonRpcException(JsonRpcExceptionType.GenericError, "The item is a valid message");
            }
        ...
        public T GetMessage()
        {
            if (!IsValid)
            {
                throw new JsonRpcException(JsonRpcExceptionType.GenericError, "The item is an invalid message");
            }
